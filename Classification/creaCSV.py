...
def createCSV(temp,activity,sMov,sDoor,task,action,time):
    ...
    PATH='./Update_Label/feature_vector'+str(time)+'.csv'
    ...
    N_TASK = 13
    N_ACTION = 12
    CONS = 3 #numero campi del consumo nel csv
    ...
    with open(PATH, mode='w',newline='') as employee_file:
        ...
        employee_writer.writerow(head) # scrive intenstazione delle colonne 
        ...
        for i in range(1,N_PATIENTS+1):
            ...
            while True:
                ...
                #assegna UP o DOWN se cresce o decresce rispetto alla finestra precedente
                if f_vector[-1] > f_vector[-2]:
                    f_vector[-1] = "UP"
                else:
                    f_vector[-1] = "DOWN"
                #aggiungere ultima feature prossimo consumo
...
if __name__ == "__main__":
    ...
    for t in time:
        createCSV(True,True,True,True,True,True,t)   #parametri: temperatura,attività,movimento,porte,task,azioni,tempo